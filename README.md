...
Remotionremotionremotionremotionremotionremotionremotionremotion is rendering videos based on Timeline (timeline.json in project folder). The timeline is generated by CLI.
