...
const FeatureRow: React.FC<{
  ...
  <div style={{
    ...
    <div style={{ fontFamily: "monospace", fontSize: 13, color: color, display: "flex", alignItems: "center", gap: 6 }}>
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0e1a", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: "monospace", fontSize: 12, color: TEAL,
          letterSpacing: "0.2em", marginBottom: 36, opacity: headIn,
        ...
        <div style={{
          marginTop: 36, display: "flex", gap: 48,
          opacity: tickerIn,
        }}>
          {[
